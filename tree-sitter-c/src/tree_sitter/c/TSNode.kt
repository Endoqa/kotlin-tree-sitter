...
public value class TSNode(
    ...
    public val context: NativeArray<uint32_t>
        get() = TSNode.contextHandle.invokeExact(this.`$mem`, 0L) as MemorySegment
    ...
    public constructor(gc: Boolean) : this(kotlin.run {
        ...
        Arena.ofAuto().allocate(TSNode.layout)
    })
    ...
    public companion object {
        ...
        @JvmStatic
        public fun allocate(alloc: SegmentAllocator): TSNode = TSNode(alloc.allocate(TSNode.layout))
    }
}
