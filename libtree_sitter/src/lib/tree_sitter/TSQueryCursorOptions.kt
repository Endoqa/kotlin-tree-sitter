...
@JvmInline
public value class TSQueryCursorOptions(
    ...
    public var progress_callback: Pointer<(state: Pointer<TSQueryCursorState>) -> Boolean>
    ...
    public companion object {
        ...
        @JvmStatic
        public fun allocate(alloc: SegmentAllocator): TSQueryCursorOptions =
            TSQueryCursorOptions(alloc.allocate(layout))

        public fun interface progress_callback {
            @CFunctionInvoke
            public fun invoke(state: Pointer<TSQueryCursorState>): Boolean
